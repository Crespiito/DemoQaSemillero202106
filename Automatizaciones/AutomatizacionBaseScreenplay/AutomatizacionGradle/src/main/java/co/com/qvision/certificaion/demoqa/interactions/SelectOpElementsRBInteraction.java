...
public class SelectOpElementsRBInteraction implements Interaction {
    @Override
    ...
    public static SelectOpElementsRBInteraction seleccionar(){
        return Tasks.instrumented(SelectOpElementsRBInteraction.class);
    }
}
