...
public class ValidarButtonAlertsQuestion implements Question {
    @Override
    ...
    public static ValidarButtonAlertsQuestion validarButtonAlertsQuestion(){
        return new ValidarButtonAlertsQuestion();
    }
}
