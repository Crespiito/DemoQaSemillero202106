...
public class FormPages {
    ...
    public static final Target GENERO = Target.the("Genero").locatedBy("//*[@for='gender-radio-2']");
   ...
   // public static final Target CITY = Target.the("OPTION CITY").locatedBy("//*[@id='city']/div/div[2]/div");
